function solution(id_list, report, k) {
  ...
  //   console.log(willSendId, "willSendId");
  ...
  //   console.log(filteredReportCountArray);

  //   console.log(filteredReportCountArray, "filteredReportCountArray", reportSet);
  const filteredReportSet = reportSet.filter((id) => filteredReportCountArray.includes(id[1])).map((id) => id[0]);
  console.log(filteredReportSet, "filteredReportSet");

  //   console.log(willSendId);

  filteredReportSet.forEach((id) => willSendId[id]++);

  console.log(Object.values(willSendId));
